...
\newcommand{\incfig}[1]{%
    ...
    \fbox{\import{./figures/chap\thechapter/}{#1.pdf_tex}}
    \vspace*{-8pt}
}
...
\newtheorem{cor}{Corollario}[subsection] % reset theorem numbering for each chapter
...
\renewpagestyle{scrheadings}{
    ...
    {\makebox[\mynewlength][l]{\makebox[2em][r]{\thepage}\quad\rule[-40pt]{1.3pt}{50pt}\quad\makebox[2em][l]{DINAMICA NON LINEARE}}}%
    {}
}
